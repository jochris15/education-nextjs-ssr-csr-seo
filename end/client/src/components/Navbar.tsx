        ...
        <>
            <nav className="sticky top-0 z-10 p-3 bg-white border-2 border-black shadow-[0px_2px_0px_rgba(0,0,0,1)] flex justify-between items-center">
                <div className="flex justify-center items-center">
                    ...
                    <Link
                        href="/products/add-client"
                        className={isActive('/products/add-client') ? "text-xl font-bold px-4 cursor-pointer underline decoration-black" : "text-xl font-bold px-4 cursor-pointer"}
                    >
                        <span>Add - Client</span>
                    </Link>
                    <Link
                        href="/products/add-server"
                        className={isActive('/products/add-server') ? "text-xl font-bold px-4 cursor-pointer underline decoration-black" : "text-xl font-bold px-4 cursor-pointer"}
                    >
